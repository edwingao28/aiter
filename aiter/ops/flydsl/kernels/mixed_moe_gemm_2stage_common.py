...
def compile_mixed_moe_gemm1_common(
    *,
    ...
    xcd_swizzle: int = 0,
    k_wave: int = 1,
    shared_expert_id: Optional[int] = None,
):
    ...
    module_name = (
        ...
        f"_t{tile_m}x{tile_n}x{tile_k}_pm{persist_m}{fp4q_tag}{fp8q_tag}{sort_tag}{async_tag}{sk_tag}{kw_tag}{go_tag}{gui_tag}{as1_tag}{xcd_tag}{heterogeneous_tag}_v{kernel_version}"
    ).replace("-", "_")
